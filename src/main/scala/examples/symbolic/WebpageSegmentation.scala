...
object WebpageSegmentation extends Serializable {
  ...
  def intersects(rect1: IndexedSeq[TaintedInt], rect2: IndexedSeq[TaintedInt]): Option[(TaintedInt, TaintedInt, TaintedInt, TaintedInt)] = {
    ...
    if (_root_.monitoring.Monitors.monitorPredicateSymEx(endpointax < startpointbx && startpointax < startpointbx, (List[Any](endpointax, startpointbx, startpointax, startpointbx), List[Any]()), 0)) {
      return None
    }
    if (_root_.monitoring.Monitors.monitorPredicateSymEx(endpointbx < startpointax && startpointbx < startpointax, (List[Any](endpointbx, startpointax, startpointbx, startpointax), List[Any]()), 1)) {
      return None
    }
    if (_root_.monitoring.Monitors.monitorPredicateSymEx(endpointby < startpointay && startpointby < startpointay, (List[Any](endpointby, startpointay, startpointby, startpointay), List[Any]()), 2)) {
      return None
    }
    if (_root_.monitoring.Monitors.monitorPredicateSymEx(endpointay < startpointby && startpointay < startpointby, (List[Any](endpointay, startpointby, startpointay, startpointby), List[Any]()), 3)) {
      return None
    }
    if (_root_.monitoring.Monitors.monitorPredicateSymEx(startpointay > endpointby, (List[Any](startpointay, endpointby), List[Any]()), 4)) {
      return None
    }
    var iSWx, iSWy, iWidth, iHeight = new TaintedInt(0)

    if (_root_.monitoring.Monitors.monitorPredicateSymEx(startpointax <= startpointbx && endpointbx <= endpointax, (List[Any](startpointax, startpointbx, endpointbx, endpointax), List[Any]()), 5)) {
      iSWx = startpointbx
      iSWy = if (_root_.monitoring.Monitors.monitorPredicateSymEx(startpointay < startpointby, (List[Any](startpointay, startpointby), List[Any](startpointax, startpointbx, endpointbx, endpointax)), 6)) startpointby else startpointay
      iWidth = bWidth
      val top = if (_root_.monitoring.Monitors.monitorPredicateSymEx(endpointby < endpointay, (List[Any](endpointby, endpointay), List[Any](startpointax, startpointbx, endpointbx, endpointax)), 7)) endpointby else endpointay
      iHeight = top - iSWy
    } else if (_root_.monitoring.Monitors.monitorPredicateSymEx(startpointbx <= startpointax && endpointax <= endpointbx, (List[Any](startpointbx, startpointax, endpointax, endpointbx), List[Any](startpointax, startpointbx, endpointbx, endpointax)), 8)) {
      iSWx = startpointax
      iSWy = if (_root_.monitoring.Monitors.monitorPredicateSymEx(startpointay < startpointby, (List[Any](startpointay, startpointby), List[Any](startpointax, startpointbx, endpointbx, endpointax, startpointbx, startpointax, endpointax, endpointbx)), 9)) startpointby else startpointay
      iWidth = aWidth
      val top = if (_root_.monitoring.Monitors.monitorPredicateSymEx(endpointby < endpointay, (List[Any](endpointby, endpointay), List[Any](startpointax, startpointbx, endpointbx, endpointax, startpointbx, startpointax, endpointax, endpointbx)), 10)) endpointby else endpointay
      iHeight = top - iSWy
    } else if (_root_.monitoring.Monitors.monitorPredicateSymEx(startpointax >= startpointbx && startpointax <= endpointbx, (List[Any](startpointax, startpointbx, startpointax, endpointbx), List[Any](startpointax, startpointbx, endpointbx, endpointax, startpointbx, startpointax, endpointax, endpointbx)), 11)) {
      iSWx = startpointax
      ...
      val top = if (_root_.monitoring.Monitors.monitorPredicateSymEx(endpointby < endpointay, (List[Any](endpointby, endpointay), List[Any](startpointax, startpointbx, endpointbx, endpointax, startpointbx, startpointax, endpointax, endpointbx, startpointax, startpointbx, startpointax, endpointbx)), 13)) endpointby else endpointay
      iHeight = top - iSWy
