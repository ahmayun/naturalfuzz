...
object RunProvFuzz {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val outputDir = "src/main/scala/scoverage_results"
    ...
    // Probing and Fuzzing
    val probingDataset = ProvFuzzUtils.CreateProbingDatasets(schema)
    val (provInfo, timeStartProbe, timeEndProbe) = ProvFuzzUtils.Probe(probeProgram, probingDataset)
