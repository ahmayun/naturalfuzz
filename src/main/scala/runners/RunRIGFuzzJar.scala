...
//        val name = "Q6"
//        val _mutantName = "Q6_M0"
//        (name,
//          _mutantName,
//          "local[*]",
//          Array("customer_address", "customer", "store_sales", "date_dim", "item").map { s => s"/home/ahmad/Documents/VT/project2/tpcds-datagen/tpcds_noheader_nocommas/$s" },
//          "20",
//          s"target/rig-output-local/$name")
      }
